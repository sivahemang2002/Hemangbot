...
client.on('message', async message => {
    ...
    if(message.content === "!archive")
      ...
      const roleName = message.member.roles.cache.find(r => r.id === "811204818433081365")
      if(roleName)
{
            ...
            message.react('🇦')
                ...
                if (message.channel.id === "712640459473813574") {
                    message.react('👍')
                        ...
                        var response = ['Ghanta','Not likely','Too hard to tell','Quite Possible','Definitely','Maybe','Yes','Ghanta','Probably not'];
