        ...
        if (message.channel.id === "806566443385618504") {
            message.react('🇦')
                ...
                if (message.channel.id === "712640459473813574") {
                 ...
                 {
                   message.channel.send("ThisisUs:<@427427280482992128><@!427714149607538688><@724871282877005846><@!729784244204732458><@!80582073676949096><@701364406486827089><@516993440920240128><@!728868019438354432>")
                 }
                });
